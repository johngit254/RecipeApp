...
import com.example.deliciousfood.utils.FoodUtils.getLunchRecipes
import com.example.deliciousfood.view.adapters.RecipeAdapter
import com.example.deliciousfood.databinding.FragmentLunchBinding
...
class LunchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val lunchRecipeList = getLunchRecipes()

        val adapter = RecipeAdapter(requireContext(), lunchRecipeList)
        ...
        binding.listViewRecipes.setOnItemClickListener { parent, view, position, id ->
            ...
            val selectedRecipe: FoodModel = lunchRecipeList.get(position)
